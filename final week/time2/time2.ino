...
void loop()
{
  ...
  // wait to see if a reply is available
    ...
    */
    ...
    /*
    //------------------ write
    Serial.write((x  % 86400L) / 3600); // print the hour (86400 equals secs per day)
    if ( ((x % 3600) / 60) < 10 ) {
      // In the first 10 minutes of each hour, we'll want a leading '0'
      Serial.write(0);
    }
    delay(s);
    Serial.write((x  % 3600) / 60); // print the minute (3600 equals secs per minute)
    if ( (x % 60) < 10 ) {
      // In the first 10 seconds of each minute, we'll want a leading '0'
      Serial.write(0);
    }
    delay(s);
    Serial.write(x % 60); // print the second
    delay(s);
    Serial.write (98);
    delay(s);
    //-------------------------------------------------------------
  ...
  /*
    ...
    delay(s);
    Serial.print(x % 60); // print the second
    delay(s);
    Serial.println(98);
    delay(s);
    //-------------------------------------------------------------
